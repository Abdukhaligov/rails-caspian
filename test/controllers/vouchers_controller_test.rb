...
class VouchersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voucher" do
    assert_difference('Voucher.count') do
      post vouchers_url, params: { voucher: { description: @voucher.description, event_id: @voucher.event_id, membership_id: @voucher.membership_id, name: @voucher.name, template: @voucher.template, uniq: @voucher.uniq } }
    end
  ...
  test "should update voucher" do
    patch voucher_url(@voucher), params: { voucher: { description: @voucher.description, event_id: @voucher.event_id, membership_id: @voucher.membership_id, name: @voucher.name, template: @voucher.template, uniq: @voucher.uniq } }
