...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { gold: @partner.gold, name: @partner.name, url: @partner.url } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { gold: @partner.gold, name: @partner.name, url: @partner.url } }
