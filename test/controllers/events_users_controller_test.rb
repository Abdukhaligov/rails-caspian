...
class EventsUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create events_user" do
    assert_difference('EventsUser.count') do
      post events_users_url, params: { events_user: { event_id: @events_user.event_id, membership_id: @events_user.membership_id, status: @events_user.status, user_id: @events_user.user_id } }
    end
  ...
  test "should update events_user" do
    patch events_user_url(@events_user), params: { events_user: { event_id: @events_user.event_id, membership_id: @events_user.membership_id, status: @events_user.status, user_id: @events_user.user_id } }
